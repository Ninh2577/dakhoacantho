            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ $article->category->public_url }}" class="ml-1 md:ml-2 hover:text-teal-600 transition-colors font-medium">
                    ...
                    <div class="p-6 md:p-10 border-b border-slate-100 bg-gradient-to-b from-slate-50/50 to-white">
                        ...
                        <div class="flex flex-wrap items-center gap-4 text-xs md:text-sm text-slate-500 font-semibold">
                            ...
                            <div class="flex items-center gap-1.5">
                                ...
                                <span>Tác giả: {{ $article->author?->name ?? match ($article->category?->slug) {
                    ...
                    <div class="p-6 md:p-10">
                        ...
                        <div class="flex items-start gap-2.5 text-xs md:text-sm text-slate-500 bg-slate-50/50 border border-slate-100 rounded-2xl p-4 my-6">
                            ...
                            <p class="leading-relaxed">
                                <strong>Nguồn tham khảo uy tín:</strong> Bài viết tham khảo dựa trên tư liệu từ các tổ chức sức khỏe uy tín thế giới bao gồm: 
