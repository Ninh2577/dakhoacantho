@php
    $services = [
        [
            ...
            'url' => ($cat = \App\Models\Category::findBySlug('nam-khoa')) ? $cat->public_url : route('category.show', ['category_path' => 'nam-khoa']),
        ...
        [
            ...
            'url' => ($cat = \App\Models\Category::findBySlug('phu-khoa')) ? $cat->public_url : route('category.show', ['category_path' => 'phu-khoa']),
        ...
        [
            ...
            'url' => ($cat = \App\Models\Category::findBySlug('benh-xa-hoi')) ? $cat->public_url : route('category.show', ['category_path' => 'benh-xa-hoi']),
        ...
        [
            ...
            'url' => ($cat = \App\Models\Category::findBySlug('hau-mon-truc-trang')) ? $cat->public_url : route('category.show', ['category_path' => 'hau-mon-truc-trang']),
