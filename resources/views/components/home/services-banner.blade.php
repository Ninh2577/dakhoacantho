@php
    $services = [
        [
            ...
            'url' => ($cat = \App\Models\Category::where('slug', 'nam-khoa')->first()) ? $cat->public_url : route('category.show', ['category_path' => 'nam-khoa']),
        ...
        [
            ...
            'url' => ($cat = \App\Models\Category::where('slug', 'phu-khoa')->first()) ? $cat->public_url : route('category.show', ['category_path' => 'phu-khoa']),
        ...
        [
            ...
            'url' => ($cat = \App\Models\Category::where('slug', 'benh-xa-hoi')->first()) ? $cat->public_url : route('category.show', ['category_path' => 'benh-xa-hoi']),
        ...
        [
            ...
            'url' => ($cat = \App\Models\Category::where('slug', 'hau-mon-truc-trang')->first()) ? $cat->public_url : route('category.show', ['category_path' => 'hau-mon-truc-trang']),
            'icon' => '<svg class="w-6 h-6 text-clinic-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>'
        ],
        [
            'label' => 'Ngoại khoa',
            'desc' => 'Tiểu phẫu ngoại khoa, cắt bao quy đầu thẩm mỹ vô trùng',
            'url' => ($cat = \App\Models\Category::where('slug', 'ngoai-khoa')->first()) ? $cat->public_url : route('category.show', ['category_path' => 'ngoai-khoa']),
