...
@section('title', 'Chuyên Khoa Nam Khoa - Giải Pháp Chăm Sóc Sức Khỏe Toàn Diện | Đa Khoa Gia Phước')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div class="lg:col-span-7 space-y-6">
                    ...
                    <p class="text-slate-650 text-base md:text-lg leading-relaxed max-w-xl">
                        Với đội ngũ bác sĩ đầu ngành và công nghệ y khoa hiện đại, chúng tôi cam kết mang lại sự riêng tư, chính xác và hiệu quả tối ưu cho mọi khách hàng.
                    </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-blue-50/10 rounded-3xl border border-slate-100 p-8 hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between group">
                    <div>
                        ...
                        <p class="text-slate-500 text-sm leading-relaxed mb-6">
                            Cắt bao quy đầu bằng kỹ thuật xâm lấn tối thiểu Hàn Quốc, không đau, thẩm mỹ cao, hồi phục nhanh chóng.
                        </p>
                    </div>
                ...
                <div class="bg-blue-50/10 rounded-3xl border border-slate-100 p-8 hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between group">
                    <div>
                        ...
                        <p class="text-slate-500 text-sm leading-relaxed mb-6">
                            Điều trị dứt điểm xuất tinh sớm, rối loạn cương dương liệu pháp tâm lý và thuốc đặc trị hiệu quả.
                        </p>
                    </div>
                    <a href="#booking-form-namkhoa" class="inline-flex items-center text-clinic-blue font-bold text-sm hover:underline">
                        Tìm hiểu thêm &rarr;
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div class="lg:col-span-6 space-y-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h4 class="font-bold text-white text-base">Chuyên gia đầu ngành</h4>
                                <p class="text-slate-350 text-sm mt-1 leading-relaxed">
                                    Hội tụ các bác sĩ chuyên khoa Nam học hơn 20 năm kinh nghiệm tại các bệnh viện lớn.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-slate-350 text-sm mt-1 leading-relaxed">
                                    Trang thiết bị hiện đại nhập khẩu trực tiếp từ Mỹ, Đức, Hàn Quốc hỗ trợ điều trị chính xác.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="lg:col-span-6 relative">
                    ...
                    <div class="absolute -bottom-6 left-6 bg-clinic-blue text-white p-5 rounded-2xl shadow-2xl border border-white/10 max-w-[200px]">
                        <h4 class="text-2xl font-black">100%</h4>
                        <p class="text-xs text-blue-200 mt-1 leading-normal font-bold">An tâm tuyệt đối</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 lg:py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row md:items-end justify-between mb-12">
                <div class="space-y-3">
                    <span class="text-xs font-bold text-clinic-blue uppercase tracking-widest">Đội ngũ y bác sĩ</span>
                    <h2 class="text-3xl md:text-4xl font-extrabold text-slate-900 tracking-tight">
                        Đội Ngũ Bác Sĩ Chuyên Gia
                    </h2>
                    <p class="text-slate-500 text-sm max-w-xl">
                        Những chuyên gia nam học hàng đầu, luôn sẵn sàng lắng nghe và đồng hành cùng sức khỏe của bạn.
                    </p>
                </div>
                <div class="mt-4 md:mt-0">
                    <a href="#booking-form-namkhoa" class="inline-flex items-center justify-center px-5 py-2.5 border-2 border-clinic-blue hover:bg-clinic-blue hover:text-white text-clinic-blue font-extrabold rounded-xl transition-all text-sm uppercase tracking-wide">
                        Xem tất cả đội ngũ
                    </a>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                <!-- Bác sĩ 1 -->
                <div class="bg-slate-50 rounded-3xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-lg transition-all duration-300">
                    <div class="aspect-square rounded-b-3xl overflow-hidden bg-slate-200">
                        <img src="https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?auto=format&fit=crop&q=80&w=600" 
                             alt="BS. CKII Nguyễn Thành" class="w-full h-full object-cover">
                    </div>
                    <div class="p-6 text-center">
                        <h4 class="font-extrabold text-slate-900 text-base">BS. CKII Nguyễn Thành</h4>
                        <p class="text-xs text-clinic-sky font-bold mt-1">Trưởng khoa Nam học</p>
                        <a href="#booking-form-namkhoa" class="mt-4 inline-block w-full py-2 bg-white hover:bg-blue-50 border border-blue-100 text-clinic-blue text-xs font-bold rounded-xl transition-all">
                            Đặt lịch bác sĩ
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-slate-50 rounded-3xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-lg transition-all duration-300">
                    <div class="aspect-square rounded-b-3xl overflow-hidden bg-slate-200">
                        <img src="https://images.unsplash.com/photo-1537368910025-700350fe46c7?auto=format&fit=crop&q=80&w=600" 
                             alt="ThS. BS Lê Mai" class="w-full h-full object-cover">
                    </div>
                    <div class="p-6 text-center">
                        <h4 class="font-extrabold text-slate-900 text-base">ThS. BS Lê Mai</h4>
                        <p class="text-xs text-clinic-sky font-bold mt-1">Chuyên gia Phẫu thuật</p>
                        <a href="#booking-form-namkhoa" class="mt-4 inline-block w-full py-2 bg-white hover:bg-blue-50 border border-blue-100 text-clinic-blue text-xs font-bold rounded-xl transition-all">
                            Đặt lịch bác sĩ
                        </a>
                    </div>
                ...
                <div class="bg-slate-50 rounded-3xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-lg transition-all duration-300">
                    <div class="aspect-square rounded-b-3xl overflow-hidden bg-slate-200">
                        <img src="https://images.unsplash.com/photo-1622253692010-333f2da6031d?auto=format&fit=crop&q=80&w=600" 
                             alt="BS. Trần Quốc Việt" class="w-full h-full object-cover">
                    </div>
                    <div class="p-6 text-center">
                        <h4 class="font-extrabold text-slate-900 text-base">BS. Trần Quốc Việt</h4>
                        <p class="text-xs text-clinic-sky font-bold mt-1">Chuyên khoa Tiết niệu</p>
                        <a href="#booking-form-namkhoa" class="mt-4 inline-block w-full py-2 bg-white hover:bg-blue-50 border border-blue-100 text-clinic-blue text-xs font-bold rounded-xl transition-all">
                            Đặt lịch bác sĩ
                        </a>
                    </div>
                ...
                <div class="bg-slate-50 rounded-3xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-lg transition-all duration-300">
                    <div class="aspect-square rounded-b-3xl overflow-hidden bg-slate-200">
                        <img src="https://images.unsplash.com/photo-1559839734-2b71ea197ec2?auto=format&fit=crop&q=80&w=600" 
                             alt="BS. Phạm Minh Hoàng" class="w-full h-full object-cover object-top">
                    </div>
                    <div class="p-6 text-center">
                        <h4 class="font-extrabold text-slate-900 text-base">BS. Phạm Minh Hoàng</h4>
                        <p class="text-xs text-clinic-sky font-bold mt-1">Cố vấn chuyên môn</p>
                        <a href="#booking-form-namkhoa" class="mt-4 inline-block w-full py-2 bg-white hover:bg-blue-50 border border-blue-100 text-clinic-blue text-xs font-bold rounded-xl transition-all">
                            Đặt lịch bác sĩ
                        </a>
                    </div>
    ...
    <section class="py-16 bg-gradient-to-r from-clinic-blue to-[#0b4c8c] text-white relative overflow-hidden text-center border-t border-white/5">
        ...
        <div class="max-w-4xl mx-auto px-4 relative z-10 space-y-6">
            ...
            <p class="text-sm md:text-base text-blue-150 max-w-xl mx-auto font-medium">
                Liên hệ ngay để được tư vấn bảo mật cùng chuyên gia nam học hàng đầu tại Đa Khoa Gia Phước Cần Thơ.
            </p>
            <div class="flex flex-wrap justify-center gap-4 pt-2">
                <a href="tel:02923813867" class="inline-flex items-center justify-center px-6 py-3.5 bg-white text-clinic-blue font-extrabold rounded-xl transition-all shadow-md text-sm gap-2">
