...
@endphp
<div id="tinymce-wrapper-{{ $safeId }}" wire:key="tinymce-wrapper-{{ $safeId }}" x-data="tinymceEditor({
    ...
    <div class="flex justify-end bg-slate-50 border-b border-slate-200 px-4 pt-2 gap-1 select-none">
        <button type="button" @click="switchTab('visual')"
    ...
    <div class="relative w-full flex-grow">
        ...
        <textarea id="tinymce-content-{{ $safeId }}" x-ref="editor" x-model.lazy="state" @input="state = $el.value"
                ...
                Alpine.data('tinymceEditor', (config) => ({
                    ...
                    initEditor() {
                        ...
                        tinymce.init({
                            ...
                            content_style: 'body { font-family: "Inter", Arial, sans-serif; font-size: 16px; line-height: 1.7; color: #334155; width: 100%; max-width: none; margin: 0; padding: 1.5rem; box-sizing: border-box; } p { margin-top: 0; margin-bottom: 1em; } img, figure, table, blockquote { max-width: 100%; } figure.image { text-align: center; margin: 1.5rem 0; } figure.image img { border-radius: 0.75rem; max-width: 100%; height: auto; box-shadow: 0 4px 6px -1px rgb(0 0 0 / 0.1); } figure.image figcaption { margin-top: 5px; font-size: 0.9em; color: #666; font-style: italic; cursor: text; user-select: text; -webkit-user-select: text; } .mce-content-body[data-mce-placeholder]:not(.mce-visualblocks)::before { top: 1.5rem !important; left: 1.5rem !important; right: 1.5rem !important; }',
